...
public class SercurityController {
    ...
    @PostMapping("/sign-in")
    public ResponseEntity<?> login(@Valid @RequestBody SignInRequet signInRequet){
        ...
        return ResponseEntity.ok(new JwtResponse(token,customUserDetails.getUsername(), customUserDetails.getRole()));
    }
}
